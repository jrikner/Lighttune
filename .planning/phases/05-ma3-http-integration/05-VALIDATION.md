...
|---------|------|------|-------------|-------------------|--------|
| 05-01-01 | 01 | 1 | ARCH-04 | `test -f lua/bridge_client.lua` | ⬜ pending |
| 05-01-02 | 01 | 1 | ARCH-04, MTR-03 | grep `ok`/`kind`/`fetch_measurement` in bridge_client | ⬜ pending |
| 05-01-03 | 01 | 1 | ARCH-04 | loader includes bridge_client in domain table | ⬜ pending |
| 05-02-01 | 02 | 2 | MTR-03, MTR-04 | monolith uses bridge_client; error mapper exists | ⬜ pending |
| 05-02-02 | 02 | 2 | MTR-06 | Bridge Status shows auth_required/last_error | ⬜ pending |
| 05-02-03 | 02 | 2 | MTR-03 | C7000-only remote gate in get_measurement_params | ⬜ pending |
| 05-03-01 | 03 | 3 | MTR-05 | auto-loop still uses bridge_client; MAX_AUTO_ATTEMPTS=3 | ⬜ pending |
| 05-03-02 | 03 | 3 | D-99 | `tests/test_bridge_client.lua` 15+ assertions | ⬜ pending |
| 05-03-03 | 03 | 3 | ARCH-04–MTR-06 | full validation sign-off | ⬜ pending |
...
| # | Gate | Requirement |
|---|------|-------------|
| 1 | `lua/bridge_client.lua` exists; monolith Section 2c delegates to module | ARCH-04 |
| 2 | `lua5.4 tests/run.lua` — 154+ PASS (139 baseline + 15 bridge), 0 FAIL | TST-01 extension |
| 3 | `pytest` bridge suite green (9 tests) | regression |
...
| 7 | Bridge Status + Setup from main menu | MTR-06, D-75 |
...
- [ ] ARCH-04, MTR-03, MTR-04, MTR-05, MTR-06 referenced
- [ ] Phase 4 setup wizard preserved
