...
See /workspace/.cursor/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspace/.cursor/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspace/.cursor/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspace/.cursor/gsd-core/templates/discovery.md
...
Use /workspace/.cursor/gsd-core/templates/discovery.md.
