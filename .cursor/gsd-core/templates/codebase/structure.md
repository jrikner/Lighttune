...
- Usage: Reference from command with `@/workspace/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /workspace/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /workspace/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
